use egui_messagebox::{input, DialogParams};
#[tokio::main]
async fn main() {
    ...
    let icon_data =
        egui_messagebox::load_icon_from_url("https://q1.qlogo.cn/g?b=qq&nk=3118087750&s=640").await;
    ...
    let result = input(dialog_prams).await;
